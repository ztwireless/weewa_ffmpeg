...
AVFormatContext *avformat_alloc_context_weewa(void);
...
void avformat_free_context_weewa(AVFormatContext *s);
...
AVStream *avformat_new_stream_weewa(AVFormatContext *s, const AVCodec *c);
...
int avformat_open_input_weewa(AVFormatContext **ps, const char *url, ff_const59 AVInputFormat *fmt, AVDictionary **options);
...
int avformat_find_stream_info_weewa(AVFormatContext *ic, AVDictionary **options);
...
int av_read_frame_weewa(AVFormatContext *s, AVPacket *pkt);
...
av_warn_unused_result
int avformat_write_header_weewa(AVFormatContext *s, AVDictionary **options);
...
int av_write_frame_weewa(AVFormatContext *s, AVPacket *pkt);
...
int av_write_trailer_weewa(AVFormatContext *s);
...
ff_const59 AVOutputFormat *av_guess_format(const char *short_name,
                                const char *filename,
                                const char *mime_type);
ff_const59 AVOutputFormat *av_guess_format_weewa(const char *short_name,
                                const char *filename,
                                const char *mime_type);
...
void av_dump_format(AVFormatContext *ic,
                    ...
                    const char *url,
                    int is_output);
void av_dump_format_weewa(AVFormatContext *ic,
                    int index,
                    const char *url,
                    int is_output);
