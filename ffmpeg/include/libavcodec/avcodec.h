...
AVCodecContext *avcodec_alloc_context3_weewa(const AVCodec *codec);
...
int avcodec_parameters_to_context_weewa(AVCodecContext *codec,
                                  const AVCodecParameters *par);
...
int avcodec_open2_weewa(AVCodecContext *avctx, const AVCodec *codec, AVDictionary **options);
...
int avcodec_close_weewa(AVCodecContext *avctx);
...
int avcodec_send_packet_weewa(AVCodecContext *avctx, const AVPacket *avpkt);
...
int avcodec_receive_frame_weewa(AVCodecContext *avctx, AVFrame *frame);
...
int avcodec_encode_video2(AVCodecContext *avctx, AVPacket *avpkt,
                          const AVFrame *frame, int *got_packet_ptr);
attribute_deprecated
int avcodec_encode_video2_weewa(AVCodecContext *avctx, AVPacket *avpkt,
                          const AVFrame *frame, int *got_packet_ptr);
#endif
